...
public class task_1 {
    ...
    public static void printHydrogenInfo() {
        ...
        System.out.println("This is a chemical element of the periodic system with thedesignation H and atomic number 1.");
    ...
    public static void printJavaInfo() {
        ...
        System.out.println("One of the famous varieties of coffee, Kopi Luwak, isproduced here.");
    }
}
